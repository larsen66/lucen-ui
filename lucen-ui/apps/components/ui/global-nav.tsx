...
import { ConnectLogo } from '#/ui/logo-connect';
    ...
    <>
      <div className="flex h-14 items-center px-4 py-4 lg:h-auto">
        <Link
          ...
          onClick={close}
        >
          <div className="size-9 rounded-full border-2 border-gray-900 group-hover:border-gray-800 bg-gradient-to-br from-slate-800 to-slate-900 text-slate-300 group-hover:text-slate-200 shadow-inner">
            <div className="flex h-full w-full items-center justify-center">
              <ConnectLogo className="h-5 w-5" />
            </div>
          </div>
