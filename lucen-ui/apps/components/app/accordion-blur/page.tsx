...
Professional and visually appealing for any application.\`}
  ...
  const bentoCodeString = `"use client"
          ...
          <TabPanels>
            ...
            <TabPanel tabIndex="1">
              <div className="relative min-h-[600px] rounded-lg overflow-hidden">
                <GridVignetteBackground className="absolute inset-0 z-0" />
                <div className="relative z-10">
                  <CodeBlock code={bentoCodeString} language="tsx" />
                </div>
              </div>
            </TabPanel>
          </TabPanels>
